...
import { AiOutlineArrowLeft, AiOutlineBars, AiOutlineClose } from "react-icons/ai";
...
const HeaderAdmin = () => {
    ...
    return (
        <div>
            ...
            <HeaderStyles
                className={`py-3  top-header z-[999]  w-full transition-all fixed  h-[68px]  right-0 left-0 ${bgHeader ? "bg-teal-400 " : "bg-[#060b26]"
                    }`}
            >
                ...
                <div
                    className={`menu-transform inset-0 absolute z-[9999] w-full h-screen bg-red-500 duration-300	  transition-all  ${showMenu ? "translate-x-[0]" : "translate-x-[-200%]"
                        }`}
                >
