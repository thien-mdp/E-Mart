...
export const CardSeeMore = ({to}) => {
  return (
    <Link
      to={to}
      className="card cursor-pointer flex items-center justify-center  min-w-[50%] sm:min-w-[25%] h-full md:min-w-[20%] w-full  p-3 border border-blue-700 shadow-lg text-blue-700 font-semibold hover:text-white hover:bg-blue-700 m-2"
    >
      See more | shop all
    </Link>
  );
